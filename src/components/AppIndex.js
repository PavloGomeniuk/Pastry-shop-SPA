  ...
  render() {
    return (
     ...
     <section className="main-general-section">
      ...
      <h3 className="main-general-section-h3">Check some of our best products and feel the great passion for food
      </h3>
      <ul className="main-general-section-ul">
        ...
        <li className="main-general-section-ul-li-item2">
          ...
          <img src={NewImg} class="main-general-section-ul-li-item1-hide_image_new"/>
        </li>
