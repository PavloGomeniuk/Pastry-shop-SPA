...
import bg11 from '../image/111.jpg';
import bg12 from '../image/121.jpg';
import bg13 from '../image/131.jpg';
import bg21 from '../image/211.jpg';
import bg22 from '../image/221.jpg';
import bg23 from '../image/231.jpg';
import bg31 from '../image/311.jpg';
import bg32 from '../image/321.jpg';
import bg33 from '../image/331.jpg';
import bg41 from '../image/411.jpg';
import bg42 from '../image/421.jpg';
import bg43 from '../image/431.jpg'; 
import bg51 from '../image/511.jpg';
import bg52 from '../image/521.jpg';
import bg53 from '../image/531.jpg';
  ...
  render() {
    ...
    return (
     <div>
      ...
      <h1 className="main-general-section-h1">Наши последние работы тортов</h1>
      <div className="main-line"></div>
      <h3 className="main-general-section-h3">
        Делаем различные свадебные, детские, праздничные торты. Цена от 270 грн/кг
      </h3>
